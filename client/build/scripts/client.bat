...
set DEFAULT_JVM_OPTS="--module-path" "/Volumes/RCA/arcade/ArcadeHub/client/build/install/client/lib" "--add-modules" "javafx.controls,javafx.fxml,javafx.media" "-Djava.library.path=/Volumes/RCA/arcade/ArcadeHub/client/build/install/client/lib"
